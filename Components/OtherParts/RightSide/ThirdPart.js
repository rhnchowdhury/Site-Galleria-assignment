...
const ThirdPart = () => {
    ...
    const handleClick = () => {
        toast(
            "All questions given in question part.",
            {
                duration: 3000,
            }
        );
    ...
    return (
        <div className="bg-sky-200 h-64 rounded mt-5">
            ...
            <div className="mt-1">
                <button onClick={handleClick} className="w-full text-center bg-sky-500 font-medium">10 All Questions</button>            </div>
            <div className="mt-12">
                ...
                <button onClick={handleSubmit} className=" ml-5 bg-sky-600 text-white px-4 rounded-md">Submit</button>
            </div>
            <Toaster />
        </div >
    );
